...
1. La contribución de cada variable a las dimensiones y los eigenvalues (a nivel general)
1.1. Tratar de nombrar las dimensiones que salgan, o más o menos a qué se parecen
2. Luego, como se mueven a través de los años
...
```{r contribuciones, fig.width=8, echo=FALSE, warning=FALSE}
# Contribución
...
#plot.DMFA(res.dmfa, choix="group",invisible="quali", label="none")
```
