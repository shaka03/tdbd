...
$$
\beta_4(\tau)log(Cercania_Areas_Industriales) + \beta_5(\tau)Densidad_Poblacion + \beta_6(\tau)Calidad_Aire
$$
...
- Si la calidad del aire es moderada, el nivel de CO aumenta en 0.503 unidades (p. < 0.001; IC95% ≈ [0.479, 0.527]).
- Si la calidad del aire es pobre, el nivel de CO aumenta en 1.006 unidades (p. < 0.001; IC95% ≈ [0.971, 1.041]).
...
Se hace el análisis por niveles taus y se analiza si hay sobreestimación o subestimación. Ej:
...
Interpretar: comparación de la cercanía con la calidad del aire